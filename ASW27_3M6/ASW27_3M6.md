...
---
## Der Controller "Corewing Fixed Wing"
...
### 2. Der 3-Stufen-Klappenschalter (CH 11)
Dieser Schalter steuert die Verwölbung der Tragfläche (Wölbklappen und 
Querruder) für die jeweilige Flugphase:
* **Stellung Oben (Normal-Phase):** Neutralstellung (Alle Klappen im Strak).
* **Stellung Mitte (Halbe Stellung / Butterfly):**Halbe Butterflystellung.
...
| **CH 11**| Schalter **SG**| Butterfly                                  | 0%  | 40% | 80 %|
